...
data = '{"doc": {"text": "샤를 드골 대통령과 콘라드 아데나워 총리가 서명한 조약은 어느 도시에서 이루어졌는가?", "language": "kr", "domain": "common-sense"}, "arg_pairs": [[[20, 21], [11, 18]]]}'


#######
temp = json.loads(data)
sent = temp['doc']['text']
sbj = sent[temp['arg_pairs'][0][0][0]:temp['arg_pairs'][0][0][1]+1]
obj = sent[temp['arg_pairs'][0][1][0]:temp['arg_pairs'][0][1][1]+1]
print(sent)
print(sbj)
print(obj)
#######
